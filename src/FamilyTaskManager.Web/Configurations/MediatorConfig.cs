...
namespace FamilyTaskManager.Web.Configurations;
...
public static class MediatorConfig
{
    ...
    Microsoft.Extensions.Logging.ILogger logger)
  {
    ...
    services.AddMediator(options =>
    {
      ...
      options.Assemblies =
      [
        typeof(FamilyTaskManager.Core.FamilyAggregate.Family),  // Core
        // typeof(FamilyTaskManager.UseCases.Constants),         // UseCases - will add when we create handlers
