...
public static class BotConstants
{
  ...
  public static class Messages
  {
    ...
    public const string PetTasksAvailable = "Теперь вы можете создавать задачи для ухода за питомцем.\n\n" +
                                            "💡 *Полезные команды:*\n" +
                                            "📋 **/templates** — Управление шаблонами задач (автоматическое создание по расписанию)\n" +
                                            "✅ **/tasks** — Просмотр и выполнение активных задач";
