...
public class TaskInstance : EntityBase<TaskInstance, Guid>, IAggregateRoot
{
  ...
  public TaskInstance(Guid familyId, Guid petId, string title, int points, TaskType type, DateTime dueAt, Guid? templateId = null)
  {
    ...
    RegisterDomainEvent(new Events.TaskCreatedEvent(this));
  }
