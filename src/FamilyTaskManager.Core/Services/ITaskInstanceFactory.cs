...
public interface ITaskInstanceFactory
{
  ...
  /// <param name="pet">The pet entity (with Family loaded) for the task</param>
  ...
  Result<TaskInstance> CreateFromTemplate(TaskTemplate template, Pet pet, DateTime dueAt,
