...
namespace FamilyTaskManager.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251127153004_FamilyMemberToUserForeignKey")]
    partial class FamilyMemberToUserForeignKey
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FamilyTaskManager.Core.FamilyAggregate.FamilyMember", b =>
                {
                    ...
                    b.HasOne("FamilyTaskManager.Core.UserAggregate.User", null)
