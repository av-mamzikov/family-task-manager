...
**Updated `tests\FamilyTaskManager.FunctionalTests\FamilyTaskManager.FunctionalTests.csproj`:**
- Removed: `Microsoft.EntityFrameworkCore.InMemory`
- Added: `Testcontainers` and `Testcontainers.MsSql`

### 2. CustomWebApplicationFactory

**File:** `tests\FamilyTaskManager.FunctionalTests\CustomWebApplicationFactory.cs`
...
```bash
dotnet test tests\FamilyTaskManager.FunctionalTests\FamilyTaskManager.FunctionalTests.csproj
```
